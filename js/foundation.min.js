...
(window.Modernizr = (function (e, t, n) {
  ...
  var a = "2.6.0",
    ...
    N = function (e, n, r, i) {
      ...
      return (
        ...
        ((f ? a : l).innerHTML += s),
        l.appendChild(a),
        f || ((l.style.background = ""), c.appendChild(l)),
        (o = n(a, e)),
        f ? a.parentNode.removeChild(a) : l.parentNode.removeChild(l),
        !!o
      );
    },
    C = {}.hasOwnProperty,
    k;
  !s(C, "undefined") && !s(C.call, "undefined")
    ? (k = function (e, t) {
        return C.call(e, t);
      })
    : (k = function (e, t) {
    ...
    (b.svg = function () {
      return (
        !!t.createElementNS && !!t.createElementNS(y.svg, "svg").createSVGRect
      );
    }),
    (b.inlinesvg = function () {
      ...
      return (
        (e.innerHTML = "<svg/>"),
        (e.firstChild && e.firstChild.namespaceURI) == y.svg
      );
    }),
    (b.svgclippaths = function () {
      return (
        !!t.createElementNS &&
        /SVGClipPath/.test(m.call(t.createElementNS(y.svg, "clipPath")))
      );
    });
  for (var L in b)
    k(b, L) &&
      ((T = L.toLowerCase()), (f[T] = b[L]()), S.push((f[T] ? "" : "no-") + T));
  return (
  ...
  (function (e, t, n) {
    ...
    function a(e, n, r, i, s, a, f) {
      ...
      T[n] === 1 && ((g = 1), (T[n] = []), (c = t.createElement(e))),
        e == "object" ? (c.data = n) : ((c.src = n), (c.type = e)),
        (c.width = c.height = "0"),
        (c.onerror =
          c.onload =
    ...
    function f(e, t, n, r, s) {
      return (
        ...
        (t = t || "j"),
        i(e)
          ? a(t == "c" ? E : w, e, t, this.i++, n, r, s)
          : (v.splice(this.i++, 0, e), v.length == 1 && u()),
        this
      );
    }
    function l() {
    ...
    (k = function (e) {
        ...
        f.url.split(".").pop().split("?").shift(),
          f.bypass ||
            (i &&
              (i = r(i)
                ? i
                : i[e] || i[o] || i[e.split("/").pop().split("?")[0]] || u),
            f.instead
              ? f.instead(e, i, s, o, a)
              : (T[f.url] ? (f.noexec = !0) : (T[f.url] = 1),
                s.load(
                  f.url,
                  f.forceCSS ||
                    (!f.forceJS &&
                      "css" == f.url.split(".").pop().split("?").shift())
                    ? "c"
                    : n,
                  f.noexec,
                  f.attrs,
      ...
      if (i(e)) o(e, 0, h, 0);
        ...
        for (f = 0; f < e.length; f++)
          (c = e[f]),
            i(c) ? o(c, 0, h, 0) : S(c) ? k(c) : Object(c) === c && a(c, h);
...
(function (e, t) {
  ...
  v.extend({
    ...
    data: function (e, n, r, i) {
      ...
      c || (f ? (e[u] = c = v.deletedIds.pop() || ++v.uuid) : (c = u)),
  ...
  v.fn.extend({
    ...
    hasClass: function (e) {
      ...
      for (; n < r; n++)
        if (
          this[n].nodeType === 1 &&
          (" " + this[n].className + " ").replace(q, " ").indexOf(t) > -1
        )
          return !0;
      return !1;
    },
  ...
  (v.event = {
      ...
      if (!s || (s.nodeType !== 3 && s.nodeType !== 8)) {
        ...
        for (f = 0; f < m.length && !n.isPropagationStopped(); f++)
          (l = m[f][0]),
            ...
            d && d.apply(l, r),
            (d = h && l[h]),
            d && v.acceptData(l) && d.apply(l, r) === !1 && n.preventDefault();
        return (
          (n.type = y),
          !o &&
        ...
        for (s = n.target; s != this; s = s.parentNode || this)
          if (s.disabled !== !0 || n.type !== "click") {
            ...
            for (r = 0; r < d; r++)
              (l = p[r]),
                (c = l.selector),
                u[c] === t && (u[c] = v(c, this).index(s) >= 0),
                u[c] && f.push(l);
            f.length && b.push({ elem: s, matches: f });
          }
      p.length > d && b.push({ elem: this, matches: p.slice(d) });
    ...
    (function (e, t) {
        ...
        if (!o && !r)
          if ((i = j.exec(e)))
            if ((f = i[1])) {
              ...
              if (i[2])
                return w.apply(n, b.call(t.getElementsByTagName(e), 0)), n;
              if ((f = i[3]) && K && t.getElementsByClassName)
                return w.apply(n, b.call(t.getElementsByClassName(f), 0)), n;
            }
        return lt(e, t, n, r, o);
      }
      function Z(e) {
      ...
      function nt(e, t, n, r) {
        ...
        while (f) {
          if (!i || (o = P.exec(f)))
            o && ((f = f.slice(o[0].length)), (u.selector = c)),
              l.push((u = [])),
              (c = ""),
              g && (f = " " + f);
          i = !1;
          ...
          for (a in v)
            (o = W[a].exec(f)) &&
              ...
              ((c += o[0]),
              (f = f.slice(o[0].length)),
              (i = u.push({ part: a, string: o.shift(), captures: o })));
          if (!i) break;
        }
        return (
          c && (u.selector = c),
          r ? f.length : f ? Y.error(e) : b.call(T(y, l), 0)
        );
      }
      function rt(e, t, i, s) {
        var o = t.dir,
      ...
      function st(e, t, n) {
        ...
        for (; (r = e[o]); o++)
          s.relative[r.part]
            ? (i = rt(i, s.relative[r.part], t, n))
            : (i = it(
                i,
                s.filter[r.part].apply(null, r.captures.concat(t, n))
              ));
        return i;
      }
      function ot(e) {
              ...
              while ((p = E.exec(l))) {
                ...
                if (v > c) {
                  (o += l.slice(c, p.index)),
                    ...
                    H.test(o) && (h && (m = h), (h = i));
                  if ((g = q.test(o)))
                    (o = o.slice(0, -5).replace(H, "$&*")), c++;
                  p.length > 1 && p[0].replace(S, x),
                    (h = at(o, p[1], p[2], m, h, g));
                }
                o = "";
              }
            }
      ...
      function lt(e, t, i, o, u) {
        ...
        if (o) a = b.call(o, 0);
          ...
          (g = ((E = I.exec(d[0].string)) && !E.index && t.parentNode) || t),
            (m = "");
          for (p = d.length - 1; p >= 0; p--) {
            ...
            if (s.order.test(y)) {
              ...
              if (a == null) continue;
              (e = e.slice(0, e.length - m.length) + m.replace(W[y], "")),
                e || w.apply(i, b.call(a, 0));
              break;
            }
          }
        }
        if (e) {
          (l = f(e, t, u)),
            (n = l.dirruns++),
            a == null &&
              (a = s.find.TAG("*", (I.test(e) && t.parentNode) || t));
      ...
      var n,
        ...
        Q = X(function (e) {
          ...
          var t =
            m.getElementsByName &&
            m.getElementsByName(d).length ===
              2 + m.getElementsByName(d + 0).length;
      ...
      (Y.matches = function (e, t) {
        ...
        (s = Y.selectors =
          {
            ...
            preFilter: {
              ...
              PSEUDO: function (e, t, n) {
                ...
                if (e[3]) e[2] = e[3];
                  ...
                  B.test(r) &&
                    (i = nt(r, t, n, !0)) &&
                    (i = r.indexOf(")", r.length - i) - r.length) &&
                    ((r = r.slice(0, i)), (e[0] = e[0].slice(0, i))),
                    (e[2] = r);
                return e.slice(0, 3);
              },
            },
            filter: {
              ...
              PSEUDO: function (e, t, n, r) {
                var i,
                  o = s.pseudos[e] || s.pseudos[e.toLowerCase()];
                return (
                  o || Y.error("unsupported pseudo: " + e),
                  o[d]
                    ? o(t, n, r)
                    : o.length > 1
                    ? ((i = [e, e, "", t]),
        ...
        (f = Y.compile =
          function (e, t, n) {
            ...
            return (
              (o = N(e, ot(r))), (o.context = t), (o.runs = o.dirruns = 0), o
            );
          }),
        m.querySelectorAll &&
          (function () {
              ...
              (lt = function (e, r, s, o, u) {
                if (!o && !u && (!i || !i.test(e)))
                  if (r.nodeType === 9)
                    ...
                    h ? (p = p.replace(n, "\\$&")) : r.setAttribute("id", p),
                      (f = nt(e, r, u)),
                      (p = "[id='" + p + "']");
                    ...
                    try {
                      return (
                        w.apply(s, b.call(v.querySelectorAll(f.join(",")), 0)),
                        s
                      );
                    } catch (a) {
                    } finally {
                ...
                (X(function (t) {
                  ...
                  try {
                    o.call(t, "[test!='']:sizzle"),
                      s.push(W.PSEUDO.source, W.POS.source, "!=");
                  } catch (n) {}
                }),
                (s = new RegExp(s.join("|"))),
                (Y.matchesSelector = function (t, n) {
                  n = n.replace(r, "='$1']");
                  if (!u(t) && !s.test(n) && (!i || !i.test(n)))
                    try {
                      var a = o.call(t, n);
        ...
        (s.setFilters.nth = s.setFilters.eq),
        (s.filters = s.pseudos),
        (Y.attr = v.attr),
        (v.find = Y),
        (v.expr = Y.selectors),
        (v.expr[":"] = v.expr.pseudos),
        (v.unique = Y.uniqueSort),
        (v.text = Y.getText),
        (v.isXMLDoc = Y.isXML),
        (v.contains = Y.contains);
    })(e);
  var nt = /Until$/,
...
(function (e) {
  var t = function () {
    return {
      ...
      adjust: function (t) {
        var n = this;
        (n.hidden = t.parents().andSelf().filter(":hidden")),
  ...
  (jQuery.foundation = jQuery.foundation || {}),
    ...
    (e.foundation.customForms.appendCustomMarkup = function (n) {
      function i(t, n) {
        var r = e(n).hide(),
          i = r.attr("type"),
          s = r.next("span.custom." + i);
        s.length === 0 &&
          (s = e('<span class="custom ' + i + '"></span>').insertAfter(r)),
          s.toggleClass("checked", r.is(":checked")),
          s.toggleClass("disabled", r.is(":disabled"));
      }
      function s(n, r) {
        var i = t(),
          s = e(r),
          o = s.next("div.custom.dropdown"),
          u = o.find("ul"),
          a = o.find(".current"),
          f = o.find(".selector"),
          l = s.find("option"),
          ...
          d,
          v = !1;
        if (s.hasClass("no-custom")) return;
        if (o.length === 0) {
          var m = s.hasClass("small")
            ? "small"
            : s.hasClass("medium")
            ? "medium"
            : s.hasClass("large")
          ...
          (o = e(
            ...
            u.append(p),
            (v = o
              .prepend('<a href="#" class="current">' + c.html() + "</a>")
              .find(".current")),
            s.after(o).hide();
        } else
          (p = l
            ...
            .join("")),
            u.html("").append(p);
        o.toggleClass("disabled", s.is(":disabled")),
          (d = u.find("li")),
          l.each(function (t) {
            this.selected &&
          ...
          u.css("width", "inherit"),
          o.css("width", "inherit"),
          o.is(".small, .medium, .large, .expand") ||
            (o.addClass("open"),
            i.adjust(u),
            (h = d.outerWidth() > h ? d.outerWidth() : h),
            i.reset(),
            o.removeClass("open"),
            o.width(h + 18),
            u.width(h + 16));
      }
      var r = { disable_class: "js-disable-custom" };
      (n = e.extend(r, n)),
        e("form.custom input:radio[data-customforms!=disabled]").each(i),
        e("form.custom input:checkbox[data-customforms!=disabled]").each(i),
        e("form.custom select[data-customforms!=disabled]").each(s);
    });
  var n = function (t) {
      var n = 0,
        r = t.next();
      ($options = t.find("option")),
        ...
        $options.each(function () {
          ($li = e("<li>" + e(this).html() + "</li>")),
            r.find("ul").append($li);
        }),
        $options.each(function (t) {
          this.selected &&
            (r.find("li").eq(t).addClass("selected"),
            r.find(".current").html(e(this).html()));
        }),
        r.removeAttr("style").find("ul").removeAttr("style"),
        r.find("li").each(function () {
          r.addClass("open"),
            e(this).outerWidth() > n && (n = e(this).outerWidth()),
            r.removeClass("open");
        }),
        r.css("width", n + 18 + "px"),
        r.find("ul").css("width", n + 16 + "px");
    },
    r = function (e) {
      var t = e.prev(),
        n = t[0];
    ...
    i = function (t) {
      var n = t.prev(),
        r = n[0];
      !1 === n.is(":disabled") &&
        (e('input:radio[name="' + n.attr("name") + '"]')
          .next()
          .not(t)
          .removeClass("checked"),
        t.hasClass("checked") || t.toggleClass("checked"),
        (r.checked = t.hasClass("checked")),
        n.trigger("change"));
    };
  e(document).on("click", "form.custom span.custom.checkbox", function (t) {
    ...
    e(document).on("click", "form.custom label", function (t) {
      var n = e("#" + e(this).attr("for")),
        s,
        o;
      n.length !== 0 &&
        (n.attr("type") === "checkbox"
          ? (t.preventDefault(),
            (s = e(this).find("span.custom.checkbox")),
            r(s))
          : n.attr("type") === "radio" &&
            (t.preventDefault(),
            (o = e(this).find("span.custom.radio")),
            i(o)));
    }),
    e(document).on(
      "click",
      ...
      function (t) {
        ...
        if (!1 === i.is(":disabled"))
          return (
            r.toggleClass("open"),
            r.hasClass("open")
              ? e(document).bind("click.customdropdown", function (t) {
                  r.removeClass("open"), e(document).unbind(".customdropdown");
                })
              : e(document).unbind(".customdropdown"),
            !1
          );
      }
    ),
    e(document).on("click", "form.custom div.custom.dropdown li", function (t) {
      ...
      t.preventDefault(),
        t.stopPropagation(),
        e("div.dropdown").removeClass("open"),
        n.closest("ul").find("li").removeClass("selected"),
        n.addClass("selected"),
        r.removeClass("open").find("a.current").html(n.html()),
        n
          .closest("ul")
          .find("li")
          .each(function (e) {
        ...
        this.not(".reveal-modal.open").each(function () {
          ...
          function y() {
            var e = i.find(".flex-video"),
              t = e.find("iframe");
            t.length > 0 &&
              (t.data("src", t.attr("src")), t.attr("src", ""), e.fadeOut(100));
          }
          var i = e(this),
          ...
          a.length === 0 &&
            ...
            i.bind("reveal:open.reveal", v),
            i.bind("reveal:close.reveal", m),
            i.bind("reveal:closed.reveal", y),
  ...
  var t = {
    ...
    init: function (t, n) {
      var r,
        i = 0,
        s = this;
      (this.clickTimer = e.proxy(this.clickTimer, this)),
        (this.addBullet = e.proxy(this.addBullet, this)),
        (this.resetAndUnlock = e.proxy(this.resetAndUnlock, this)),
        (this.stopClock = e.proxy(this.stopClock, this)),
        (this.startTimerAfterMouseLeave = e.proxy(
          this.startTimerAfterMouseLeave,
          this
        )),
        (this.clearClockMouseLeaveTimer = e.proxy(
          this.clearClockMouseLeaveTimer,
          this
        )),
        (this.rotateTimer = e.proxy(this.rotateTimer, this)),
        (this.options = e.extend({}, this.defaults, n)),
        this.options.timer === "false" && (this.options.timer = !1),
        this.options.captions === "false" && (this.options.captions = !1),
        this.options.directionalNav === "false" &&
          (this.options.directionalNav = !1),
        (this.$element = e(t)),
        ...
        (r = this.$slides.filter("img")),
        r.length === 0
          ? this.loaded()
          : r.bind("imageready", function () {
    ...
    setDimentionsFromLargestSlide: function () {
      var t = this,
        n;
      t.$element.add(t.$wrapper).width(this.$slides.first().outerWidth()),
        t.$element.add(t.$wrapper).height(this.$slides.first().height()),
        (t.orbitWidth = this.$slides.first().outerWidth()),
        (t.orbitHeight = this.$slides.first().height()),
        (n = this.$slides.first().findFirstImage().clone()),
        this.$slides.each(function () {
          var r = e(this),
            i = r.outerWidth(),
            s = r.height();
          i > t.$element.outerWidth() &&
            (t.$element.add(t.$wrapper).width(i),
            (t.orbitWidth = t.$element.outerWidth())),
            s > t.$element.height() &&
              (t.$element.add(t.$wrapper).height(s),
              (t.orbitHeight = t.$element.height()),
              (n = e(this).findFirstImage().clone())),
            (t.numberSlides += 1);
        }),
        this.options.fluid &&
          (typeof this.options.fluid == "string" &&
            (n = e("<img>").attr(
              "data-src",
              "holder.js/" + this.options.fluid
            )),
          t.$element.prepend(n),
          n.addClass("fluid-placeholder"),
          t.$element.add(t.$wrapper).css({ width: "inherit" }),
          t.$element.add(t.$wrapper).css({ height: "inherit" }),
    ...
    updateOptionsIfOnlyOneSlide: function () {
      this.$slides.length === 1 &&
        ((this.options.directionalNav = !1),
        (this.options.timer = !1),
        (this.options.bullets = !1));
    },
    ...
    rotateTimer: function (e) {
      ...
      (this.degrees += 2),
        ...
        this.degrees > 180 &&
          (this.$rotator.addClass("move"), this.$mask.addClass("move"));
      if (this.degrees > 360 || e)
    ...
    setupTimer: function () {
      (this.$timer = e(this.timerHTML)),
        this.$wrapper.append(this.$timer),
        (this.$rotator = this.$timer.find(".rotator")),
        (this.$mask = this.$timer.find(".mask")),
        (this.$pause = this.$timer.find(".pause")),
        this.$timer.click(this.clickTimer),
        this.options.startClockOnMouseOut &&
    ...
    setupCaptions: function () {
      (this.$caption = e(this.captionHTML)),
    ...
    setupDirectionalNav: function () {
      ...
      n.find(".right").html(this.options.directionalNavRightText),
        n.find(".left").html(this.options.directionalNavLeftText),
        this.$wrapper.append(n),
        this.$wrapper.find(".left").click(function () {
          t.stopClock(),
            t.options.resetTimerOnClick && (t.rotateTimer(!0), t.startClock()),
            t.$element.trigger("orbit.prev");
        }),
        this.$wrapper.find(".right").click(function () {
          t.stopClock(),
            t.options.resetTimerOnClick && (t.rotateTimer(!0), t.startClock()),
            t.$element.trigger("orbit.next");
        });
    },
    setupBulletNav: function () {
      (this.$bullets = e(this.bulletHTML)),
        this.$wrapper.append(this.$bullets),
        this.$slides.each(this.addBullet),
        this.$element.addClass("with-bullets"),
        this.options.centerBullets &&
    ...
    addBullet: function (t, n) {
      var r = t + 1,
        ...
        s,
        o = this;
      this.options.bulletThumbs &&
        ((s = e(n).attr("data-thumb")),
        s &&
          i
            .addClass("has-thumb")
            .css({
              background:
                "url(" + this.options.bulletThumbLocation + s + ") no-repeat",
            })),
        this.$bullets.append(i),
        i.data("index", t),
        i.click(function () {
          o.stopClock(),
            o.options.resetTimerOnClick && (o.rotateTimer(!0), o.startClock()),
            o.$element.trigger("orbit.goto", [i.data("index")]);
        });
    },
    ...
    resetAndUnlock: function () {
      this.$slides.eq(this.prevActiveSlide).css({ "z-index": 1 }),
        this.unlock(),
        this.options.afterSlideChange.call(
          this,
    ...
    shift: function (e) {
      ...
      this.locked ||
        ...
        e == "next"
          ? (this.activeSlide++,
            this.activeSlide == this.numberSlides && (this.activeSlide = 0))
          : e == "prev"
          ? (this.activeSlide--,
            this.activeSlide < 0 && (this.activeSlide = this.numberSlides - 1))
          : ((this.activeSlide = e),
            this.prevActiveSlide < this.activeSlide
              ? (t = "next")
              : this.prevActiveSlide > this.activeSlide && (t = "prev")),
        ...
        this.options.animation == "horizontal-slide" &&
          (t == "next" &&
            this.$slides
              .eq(this.activeSlide)
        ...
        this.options.animation == "vertical-slide" &&
          (t == "prev" &&
            this.$slides
              .eq(this.activeSlide)
        ...
        this.options.animation == "horizontal-push" &&
          (t == "next" &&
            (this.$slides
              .eq(this.activeSlide)
              .css({ left: this.orbitWidth, "z-index": 3 })
        ...
        this.options.animation == "vertical-push" &&
          (t == "next" &&
            (this.$slides
              .eq(this.activeSlide)
              .css({ top: -this.orbitHeight, "z-index": 3 })
        ...
        this.setCaption()),
        this.$slides.last() && this.options.singleCycle && this.stopClock();
    },
  };
      ...
      add: function (r) {
        ...
        this.nodeType === 1 &&
          ...
          (t.forceLoad
            ...
            ? r.handler.apply(this, arguments)
            : n(this, r.handler));
      },
      teardown: function (t) {
...
(function (e, t) {
  function s(e, t) {
    var n = "complete",
      ...
      h = function (o) {
        (o.type != r || u.readyState == n) &&
          ((o.type == "load" ? e : u)[l](c + o.type, h, i),
          !s && (s = !0) && t.call(e, null));
      },
      p = function () {
        try {
  ...
  function o(e) {
    ...
    var t = document[
      ...
      n = [];
    return (
      t != null && (t.length ? (n = t) : t.length == 0 ? (n = t) : (n = [t])), n
    );
  }
  function u(e, t) {
    var n = {};
  ...
  function a(e, t, n) {
    ...
    (i.width = t.width),
      ...
      (e.font = "bold " + u + "px sans-serif");
    var a = n.text ? n.text : t.width + "x" + t.height;
    return (
      Math.round(e.measureText(a).width) / t.width > 1 &&
        (u = Math.max(o, n.size)),
      (e.font = "bold " + u + "px sans-serif"),
      e.fillText(a, t.width / 2, t.height / 2, t.width),
  ...
  if (!i.getContext) r = !0;
  else if (i.toDataURL("image/png").indexOf("data:image/png") < 0) r = !0;
  ...
  (e.add_theme = function (t, n) {
    ...
    (e.run = function (t) {
      ...
      for (var c = i.length, h = 0; h < c; h++) {
        var p = l.themes.gray,
          d = i[h].getAttribute("data-src") || i[h].getAttribute("src");
        if (!!~d.indexOf(n.domain)) {
          var v = !1,
            m = null,
            g = null,
            y = d.substr(d.indexOf(n.domain) + n.domain.length + 1).split("/");
          for (sl = y.length, j = 0; j < sl; j++)
            e.flags.dimensions.match(y[j])
              ? ((v = !0), (m = e.flags.dimensions.output(y[j])))
              : e.flags.colors.match(y[j])
              ? (p = e.flags.colors.output(y[j]))
              : n.themes[y[j]]
              ? (p = n.themes[y[j]])
              : e.flags.text.match(y[j]) && (g = e.flags.text.output(y[j]));
          if (v) {
            i[h].setAttribute("data-src", d);
            var b = m.width + "x" + m.height;
            i[h].setAttribute(
              "alt",
              g ? g : p.text ? p.text + " [" + b + "]" : b
            ),
              (i[h].style.backgroundColor = p.background);
...
(function (e, t, n) {
  ...
  e.fn.foundationNavigation = function (t) {
    var n = !1;
    Modernizr.touch || navigator.userAgent.match(/Windows Phone/i)
      ? (e(document).on(
          "click.fndtn touchstart.fndtn",
          ".nav-bar a.flyout-toggle",
          function (t) {
            t.preventDefault();
            var r = e(this).siblings(".flyout").first();
            n === !1 &&
              (e(".nav-bar .flyout").not(r).slideUp(500),
              r.slideToggle(500, function () {
                n = !1;
              })),
              (n = !0);
          }
        ),
        e(".nav-bar>li.has-flyout", this).addClass("is-touch"))
      : e(".nav-bar>li.has-flyout", this).hover(
          function () {
...
(function (e, t, n) {
  ...
  e.fn.foundationButtons = function (t) {
    var n = e(document);
    n.on("click.fndtn", ".button.disabled", function (e) {
      e.preventDefault();
    }),
      e(".button.dropdown > ul", this).addClass("no-hover"),
      n.on(
        "click.fndtn",
        ".button.dropdown, .button.dropdown.split span",
        function (t) {
          e(".button.dropdown").children("ul").removeClass("show-dropdown"),
            t.target === this && t.stopPropagation();
        }
      ),
      n.on("click.fndtn", ".button.dropdown.split span", function (t) {
        t.preventDefault(),
          e(".button.dropdown", this)
            .not(e(this).parent())
            .children("ul")
            .removeClass("show-dropdown"),
          e(this).siblings("ul").toggleClass("show-dropdown");
      }),
      n.on("click.fndtn", ".button.dropdown:not(.split)", function (t) {
        e(".button.dropdown", this)
          .not(this)
          .children("ul")
          .removeClass("show-dropdown"),
    ...
    var r =
        e(
          ".button.dropdown:not(.large):not(.small):not(.tiny)",
          this
        ).outerHeight() - 1,
      i = e(".button.large.dropdown", this).outerHeight() - 1,
      s = e(".button.small.dropdown", this).outerHeight() - 1,
      o = e(".button.tiny.dropdown", this).outerHeight() - 1;
    e(".button.dropdown:not(.large):not(.small):not(.tiny) > ul", this).css(
      "top",
      r
    ),
      e(".button.dropdown.large > ul", this).css("top", i),
      e(".button.dropdown.small > ul", this).css("top", s),
      e(".button.dropdown.tiny > ul", this).css("top", o),
      e(".button.dropdown.up:not(.large):not(.small):not(.tiny) > ul", this)
        .css("top", "auto")
        .css("bottom", r - 2),
      e(".button.dropdown.up.large > ul", this)
        .css("top", "auto")
        .css("bottom", i - 2),
      e(".button.dropdown.up.small > ul", this)
        .css("top", "auto")
        .css("bottom", s - 2),
      e(".button.dropdown.up.tiny > ul", this)
        .css("top", "auto")
        .css("bottom", o - 2);
  };
})(jQuery, this);
(function (e, t, n) {
  ...
  e.fn.foundationTabs = function (n) {
    var r = e.extend({ callback: e.noop }, n),
      i = function (t) {
        var n = t.closest("dl").find("dd.active"),
          r = t.children("a").attr("href"),
          i = /^#/.test(r),
          s = "";
        i &&
          ((s = r + "Tab"),
          ...
          e(s)
            ...
            .removeClass("active")
            .hide(),
          e(s).css("display", "block").addClass("active")),
    ...
    e(document).on("click.fndtn", "dl.tabs dd a", function (t) {
      ...
      t.location.hash &&
        (i(e('a[href="' + t.location.hash + '"]').parent("dd")), r.callback());
  };
})(jQuery, this);
/*
  ...
  var r = {
    ...
    i = {
      init: function (t) {
        return (
          ...
          this.each(function () {
            ...
            Modernizr.touch
              ? (t.on(
                  "click.tooltip touchstart.tooltip touchend.tooltip",
                  r.targetClass,
                  function (t) {
                    t.preventDefault(),
                      e(r.tooltipClass).hide(),
      ...
      showOrCreateTip: function (e) {
        var t = i.getTip(e);
        t && t.length > 0 ? i.show(e) : i.create(e);
      },
      getTip: function (t) {
        var n = i.selector(t),
          s = null;
        return (
          n && (s = e("span[data-selector=" + n + "]" + r.tooltipClass)),
          s.length > 0 ? s : !1
        );
      },
      selector: function (e) {
        ...
        return (
          t === n &&
            r === n &&
            ((r = "tooltip" + Math.random().toString(36).substring(7)),
            e.attr("data-selector", r)),
          t ? t : r
        );
      },
      create: function (t) {
        var n = e(
            r.tipTemplate(
              i.selector(t),
              e("<div>").text(t.attr("title")).html()
            )
          ),
          s = i.inheritable_classes(t);
        n.addClass(s).appendTo("body"),
          Modernizr.touch &&
            n.append('<span class="tap-to-close">tap to close </span>'),
          t.removeAttr("title"),
          i.show(t);
      },
      reposition: function (n, r, i) {
        ...
        r.css("visibility", "hidden").show(),
          ...
          e(t).width() < 767
            ...
            ? (l(
                r,
                n.offset().top - r.outerHeight() - u,
                "auto",
                "auto",
                n.offset().left,
                s
              ).removeClass("tip-override"),
              l(o, "auto", "auto", -u, "auto"))
            : i.indexOf("tip-left") > -1
            ? (l(
                r,
                n.offset().top + n.outerHeight() / 2 - u,
                "auto",
                "auto",
                n.offset().left - r.outerWidth() - 10,
                s
              ).removeClass("tip-override"),
              l(o, r.outerHeight() / 2 - u / 2, -u, "auto", "auto"))
      ...
      inheritable_classes: function (t) {
        var n = ["tip-top", "tip-left", "tip-bottom", "tip-right", "noradius"],
          r = e
            .map(t.attr("class").split(" "), function (t, r) {
      ...
      destroy: function () {
        return this.each(function () {
          e(t).off(".tooltip"),
            e(r.targetClass).off(".tooltip"),
            e(r.tooltipClass)
              .each(function (t) {
                e(e(r.targetClass).get(t)).attr("title", e(this).text());
              })
              .remove();
        });
      },
    ...
    if (t.value == "") {
      if (t.type == "password") {
        if (!r.data("placeholder-textinput")) {
          ...
          e
            .removeAttr("name")
            .data({ "placeholder-password": !0, "placeholder-id": s })
            .bind("focus.placeholder", l),
            r
              .data({ "placeholder-textinput": e, "placeholder-id": s })
              .before(e);
        }
  ...
  r && i
    ...
    : ((a = s.placeholder =
        function () {
          ...
          return (
            e
              .filter((r ? "textarea" : ":input") + "[placeholder]")
              .not(".placeholder")
              .bind({ "focus.placeholder": l, "blur.placeholder": c })
      ...
      (u = {
        ...
        set: function (e, r) {
          var i = n(e);
          return i.data("placeholder-enabled")
            ? (r == ""
                ? ((e.value = r), e != t.activeElement && c.call(e))
                : i.hasClass("placeholder")
...
(function (e, t, n) {
  "use strict";
  var r = { index: 0, initialized: !1 },
    i = {
      init: function (n) {
        return this.each(function () {
          (r = e.extend(r, n)),
            (r.$w = e(t)),
            (r.$topbar = e("nav.top-bar")),
            (r.$titlebar = r.$topbar.children("ul:first"));
          var s = e("<div class='top-bar-js-breakpoint'/>").appendTo("body");
          (r.breakPoint = s.width()),
            s.remove(),
            r.initialized || (i.assemble(), (r.initialized = !0)),
            r.height || i.largestUL(),
            e(".top-bar .toggle-topbar").live("click.fndtn", function (e) {
              e.preventDefault(),
                i.breakpoint() &&
                  (r.$topbar.toggleClass("expanded"),
                  r.$topbar.css("min-height", ""));
            }),
            e(".top-bar .has-dropdown>a").live("click.fndtn", function (t) {
              t.preventDefault();
              if (i.breakpoint()) {
                var n = e(this),
                  s = n.closest("li"),
                ...
                (r.index += 1),
                  s.addClass("moved"),
                  u.css({ left: -(100 * r.index) + "%" }),
                  u.find(">.name").css({ left: 100 * r.index + "%" }),
                  n
                    .siblings("ul")
                    .height(r.height + r.$titlebar.outerHeight(!0)),
                  r.$topbar.css(
                    "min-height",
                    r.height + r.$titlebar.outerHeight(!0) * 2
                  );
              }
            }),
            e(".top-bar .has-dropdown .back").live("click.fndtn", function (t) {
              t.preventDefault();
              var n = e(this),
                i = n.closest("li.moved"),
                s = n.closest("section"),
                o = i.parent();
              (r.index -= 1),
                s.css({ left: -(100 * r.index) + "%" }),
                s.find(">.name").css({ left: 100 * r.index + "%" }),
                r.index === 0 && r.$topbar.css("min-height", 0),
                setTimeout(function () {
                  i.removeClass("moved");
                }, 300);
            });
      ...
      assemble: function () {
        var t = r.$topbar.children("section");
        t.detach(),
          t.find(".has-dropdown>a").each(function () {
            var t = e(this),
      ...
      largestUL: function () {
        var t = r.$topbar.find("section ul ul"),
          n = t.first(),
          i = 0;
        t.each(function () {
          e(this).children("li").length > n.children("li").length &&
            (n = e(this));
        }),
