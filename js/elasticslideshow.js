(function (window, $, undefined) {
  ...
  $event.special.smartaddEventListener = {
    setup: function () {
      $(this).bind(
        "addEventListener",
        $event.special.smartaddEventListener.handler
      );
    },
    teardown: function () {
      $(this).unbind(
  ...
  $.Slideshow.prototype = {
    ...
    _slideTo: function (pos) {
      ...
      let $currentSlide = this.$imgItems.eq(this.current),
  ...
  $.fn.eislideshow = function (options) {
    if (typeof options === "string") {
      ...
      this.each(function () {
        let instance = $.data(this, "eislideshow");
